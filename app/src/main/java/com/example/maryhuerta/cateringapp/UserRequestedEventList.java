...
public class UserRequestedEventList extends AppCompatActivity implements RecyclerViewClickListener {
    ...
    public void populateuserRequestedEventsTest() {
        ...
        UserRequestedEventItem item = new UserRequestedEventItem("john", "JOhn", "10/10/16", "10:00am", "2hr", "KC", "100", "Wedding", "Itailian", "dinner", "formal", "regular", "Beach Ball", "non reserved");

        eventList.add(new UserRequestedEventItem("john", "JOhn", "10/10/16", "10:00am", "2hr", "KC", "100", "Wedding", "Itailian", "dinner", "formal", "regular", "Beach Ball", "non reserved"));
